<template>
  <div>
    ...
    <nav class="fixed top-0 left-0 w-full px-8 py-8 flex justify-end items-start z-[50]">
      <Button 
        @click="menuStore.toggleMenu"
        class="menu-button overflow-hidden" 
      >
        <div class="overflow-hidden">
          <span v-hover-slide class="inline-block py-0 -my-2">
            Menu
          </span>
        </div>
      </Button>
