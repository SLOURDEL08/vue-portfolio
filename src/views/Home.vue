<template>
  <DefaultLayout>
    ...
    <!-- Contenu principal avec alternance entre StandardSection et FullWidthSection -->
    
    <!-- Section 1: Photo de profil (pleine largeur) -->
    <FullWidthSection>
      <ScaleSection
    ...
    <!-- Section 3: Projets mis en avant (pleine largeur) -->
    <FullWidthSection>
      <section aria-label="Projets mis en avant" class="">
...
const StandardSection = defineAsyncComponent(() => import('../components/StandardSection.vue'))
const FullWidthSection = defineAsyncComponent(() => import('../components/FullWidthSection.vue'))
